...
const LoginPage = () => {
  ...
  return (
    <>
      ...
      <Container class="hidden sm:block absolute inset-0 w-full h-screen z-10 bg-gray-800 bg-opacity-70"></Container>
      {activeForm === 'login' &&
      ...
      {activeForm === 'register' &&
        <Container class="absolute inset-0 flex items-center justify-center my-96 z-20">
          <RegisterCard />
        </Container>
      }
    </>
