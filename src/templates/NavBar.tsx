    ...
    <>
      <nav className="bg-white z-50 dark:bg-gray-900 fixed w-full top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <Button onClick={() => {document.getElementById('info')?.scrollIntoView({ behavior: 'smooth' })}} class="bg-blue-600 text-white font-semi-bold py-2 px-3 rounded-md active:bg-opacity-65">Get started</Button>
