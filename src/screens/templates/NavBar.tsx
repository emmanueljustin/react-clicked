    ...
    <>
      <Container class="fixed w-full p-5 bg-gray-900 shadow-md z-40">
        <Container class="flex items-center justify-between px-10 w-full h-10">
          <Container onClick={() => dispatch(logout())} class="flex items-center space-x-2 select-none cursor-pointer">
              ...
              <Container onClick={() => setShowProfileOptions(!showProfileOptions)} class="relative cursor-pointer">
                ...
                {showProfileOptions && (
                  <Container class="absolute mt-1 -right-10 flex flex-col justify-center bg-gray-800 rounded-md shadow-md cursor-pointer overflow-clip space-y-2 z-50">
                    <Text class="text-white px-3 py-2 font-bold hover:bg-gray-300 hover:bg-opacity-65">Profile</Text>
                    <Text class="text-white px-3 py-2 font-bold hover:bg-gray-300 hover:bg-opacity-65">Transactions</Text>
                    <Text class="text-white px-3 py-2 font-bold hover:bg-gray-300 hover:bg-opacity-65">News</Text>
                    <Text class="text-white px-3 py-2 font-bold hover:bg-gray-300 hover:bg-opacity-65">Logout</Text>
                  </Container>
                )}
              </Container>
            )}
